<?php
session_start();
$db = new PDO("mysql:host=localhost; dbname=blog", "Javokhir_Tojiev", "Javokh09");
$out = "";
...
if (isset($_SESSION["username"])) {
    ...
    <div class="logout_panel"><a href="register.php">My Profile</a>&nbsp;|&nbsp;
    ...
    <?php
    $posts = $db->query("SELECT p.title, p.body, p.publishedDate,
       u.fullname, p.userId FROM Posts p JOIN Users u ON p.userId=u.id");
    ?>
